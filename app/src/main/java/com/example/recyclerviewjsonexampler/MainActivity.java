...
public class MainActivity extends AppCompatActivity implements ExampleAdapter.OnItemClickListner {
   ...
   public  static final String EXTRA_LIKES = "likesCount";
    ...
    private void parseJSON(){
        ...
        String url = "https://pixabay.com/api/?key=17056692-8b667ed140071c9946a5282f9&q=Kitten&image_type=photo&pretty=true ";
    ...
    public void onItemClick(int position) {
        ...
        detailIntent.putExtra(EXTRA_CREATOR,clickedItem.getCreators());
